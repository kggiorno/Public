...
# Global
all_sites = cityLinkList # All the Craiglist sites
...
class CraigslistBase(object):
    ...
    url_templates = {
        'base': 'http://%(site)s',
        'no_area': 'http://%(site)s/search/%(category)s',
        'area': 'http://%(site)s/search/%(area)s/%(category)s'
    }
    ...
    def __init__(self, site='austin.craigslist.org', area=None, category=None, filters=None,
